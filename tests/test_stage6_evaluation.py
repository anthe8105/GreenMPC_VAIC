...
from greenmpc.evaluation.runner import run_benchmark
...
def test_quick_benchmark_outputs_exist():
    summary = run_benchmark(quick=True)
    assert summary["minimum_completed_hours"] >= 24
